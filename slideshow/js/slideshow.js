...
var createSlideshow = function () {
    ...
    var timer, play = true, nodes, img, stopSlideShow, displayNextImage, setPlayText, currentSpeed=2000;
    ...
    return {
        ...
        setSpeed: function() {
            stopSlideShow();
            var speedPrompt = window.prompt("Please enter a slider speed. Your current speed is " + currentSpeed);
            currentSpeed = Number(speedPrompt);
            slideshow.startSlideShow(currentSpeed);
            return currentSpeed;
        },
        startSlideShow: function () {
            ...
            timer = setInterval(displayNextImage, currentSpeed);
            window.console.log(currentSpeed);
            return this;
        },
...
window.addEventListener("load", function () {
    ...
    $("set_speed").addEventListener("click", slideshow.setSpeed);
});
